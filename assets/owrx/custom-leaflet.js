var mapSources = [
    ...
    {
        name: 'OFFLINE - OSM Liberty',
        url: 'http://map.recovery.box/tiles/styles/liberty/{z}/{x}/{y}.png',
        config: {
            attribution: 'Map data: &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, <a href="http://viewfinderpanoramas.org">SRTM</a> | Map style: &copy; <a href="https://github.com/maputnik/osm-liberty">Maputnik OSM Liberty</a> (<a href="https://creativecommons.org/licenses/by-sa/3.0/">CC-BY-SA</a>)'
        }
    },
    {
