...
## Fixed
- Brouter : Missing profiles replaced my more pertinent ones.
...
- `rb-laptop` added to display the battery level if the hardware is a laptop. It is automatically deployed if `rb-battery` isn't activated.
