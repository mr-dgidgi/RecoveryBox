...
The wiki is the RecoveryBox technical documentation site, based on MkDocs Material.

### Service check

```bash
# MkDocs service status
...
| Issue | Possible cause | Solution |
| --- | --- | --- |
| Wiki inaccessible | MkDocs container stopped | `systemctl restart mkdocs.service` |
| 502 Bad Gateway error | Container starting up | Wait a few seconds and reload |
| Page not found after adding content | File not in the `nav` configuration | Check the `/data/wiki/mkdocs.yml` file |

!!! info "Official documentation"
    - **[MkDocs](https://www.mkdocs.org)** — Official documentation
    - **[MkDocs Material](https://squidfunk.github.io/mkdocs-material/)** — Theme used
    - Service page: [**MkDocs**](../services/mkdocs.md)
