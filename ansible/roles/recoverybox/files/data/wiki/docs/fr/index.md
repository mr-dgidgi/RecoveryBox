...
La RecoveryBox propose donc divers outils wia le web en se connectant sur le hotspot qu'elle héberge et en accédant à [http://recovery.box](http://recovery.box)
...
- **MkDocs** : Wiki technique de la RecoveryBox (documentation des services et outils). ([wiki.recovery.box](http://wiki.recovery.box))
