...
Le wiki est le site de documentation technique de la RecoveryBox, basé sur MkDocs Material.

### Vérification du service

```bash
# État du service MkDocs
...
| Problème | Cause possible | Solution |
| --- | --- | --- |
| Wiki inaccessible | Conteneur MkDocs arrêté | `systemctl restart mkdocs.service` |
| Erreur 502 Bad Gateway | Conteneur en cours de démarrage | Attendre quelques secondes puis recharger |
| Page non trouvée après ajout | Fichier non dans la navigation `nav` | Vérifier le fichier `/data/wiki/mkdocs.yml` |

!!! info "Documentation officielle"
    - **[MkDocs](https://www.mkdocs.org)** — Documentation officielle
    - **[MkDocs Material](https://squidfunk.github.io/mkdocs-material/)** — Thème utilisé
    - Fiche service : [**MkDocs**](../services/mkdocs.md)
