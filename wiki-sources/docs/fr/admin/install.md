...
Cette page décrit plus en détail le fonctionnement du script **[install.sh](RecoveryBox_install.md)**, ses prérequis et les différents scénarios d'installation possibles.
